...
def start_update(refresh_campus=False, refresh_collegetown=False):
    try:
        if refresh_campus:
            print("[{}] Fetching campus eateries".format(datetime.now()))
            data_json = requests.get(CORNELL_DINING_URL).json()
            ...
            print("[{}] Fetching and updating campus eatery hours and menus".format(datetime.now()))
            for eatery in campus_eateries:
                ...
                if eatery.slug not in STATIC_EATERY_SLUGS:
                    hours_and_menus, dining_items = parse_campus_hours(data_json, eatery)
            ...
            print("[{}] Fetching and updating static eatery hours and menus".format(datetime.now()))
            ...
            print("[{}] Fetching swipe data".format(datetime.now()))
        ...
        if refresh_collegetown:
            ...
            print("[{}] Updating collegetown eateries".format(datetime.now()))
            ...
            print("[{}] Fetching and updating collegetown eatery hours".format(datetime.now()))
